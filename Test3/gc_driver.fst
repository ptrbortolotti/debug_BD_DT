...
"../Model/bd_primary.inp"    BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"../Model/bd_primary.inp"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"../Model/bd_primary.inp"    BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
